...
const humidityValueTxt= document.querySelector(".humadity-value-txt");
...
// console.log(config.Google_ai_api);
const apikey = config.Google_ai_api;
...
async function updateForecastsInfo(city){
    const forecastData = await getFetchDate('forecast', city)
...
function showDisplaySection(section){
    ...
    [weatherInfoSection, searchCitySection, notFoundSection].forEach(section => {if (section) section.style.display = 'none'})
    // show requested
